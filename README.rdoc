...
Can any one please tell me why the following test fails:
rspec spec/requests/pages_spec.rb -e "Pages clear button should not show the string 'blah'"
You can run a server and navigate to http://localhost:3000/pages/input to convince yourself that the clear button does seem to be doing the right thing.
